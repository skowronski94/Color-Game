...
#include "../../board/fall_columns_algorithm.h"
#include <QtTest/QtTest>
#include <QDebug>

class FallColumns_test: public QObject
{
    Q_OBJECT
private slots:
    void fallColumns();
...
void FallColumns_test::fallColumns()
{
    FallColumnsAlgorithm fca;
    Board b(10, 10);
    b[0][9] = new Tile(0,0,1); b[0][8] = new Tile(0,0,0); b[0][7] = new Tile(0,0,4); b[0][6] = new Tile(0,0,4); b[0][5] = new Tile(0,0,4); b[0][4] = new Tile(0,0,4); b[0][3] = new Tile(0,0,4); b[0][2] = new Tile(0,0,1); b[0][1] = new Tile(0,0,2); b[0][0] = new Tile(0,0,4);
    ...
    Board t(10, 10);
    t[0][9] = new Tile(0,0,1); t[0][8] = new Tile(0,0,4); t[0][7] = new Tile(0,0,4); t[0][6] = new Tile(0,0,4); t[0][5] = new Tile(0,0,4); t[0][4] = new Tile(0,0,4); t[0][3] = new Tile(0,0,1); t[0][2] = new Tile(0,0,2); t[0][1] = new Tile(0,0,4); t[0][0] = new Tile(0,0,0);
    ...
    t[2][9] = new Tile(0,0,4); t[2][8] = new Tile(0,0,1); t[2][7] = new Tile(0,0,1); t[2][6] = new Tile(0,0,1); t[2][5] = new Tile(0,0,1); t[2][4] = new Tile(0,0,1); t[2][3] = new Tile(0,0,4); t[2][2] = new Tile(0,0,1); t[2][1] = new Tile(0,0,2); t[2][0] = new Tile(0,0,1);
    ...
    t[8][9] = new Tile(0,0,1); t[8][8] = new Tile(0,0,3); t[8][7] = new Tile(0,0,2); t[8][6] = new Tile(0,0,2); t[8][5] = new Tile(0,0,1); t[8][4] = new Tile(0,0,4); t[8][3] = new Tile(0,0,4); t[8][2] = new Tile(0,0,2); t[8][1] = new Tile(0,0,3); t[8][0] = new Tile(0,0,1);
