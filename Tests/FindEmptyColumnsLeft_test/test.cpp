...
class FindEmptyColumnsLeft_test: public QObject
{
    Q_OBJECT
private slots:
    void findColumnsLeft();
};

void FindEmptyColumnsLeft_test::findColumnsLeft()
{
    ...
    int result = mca.findEmptyColumnsLeft(b);
    QCOMPARE(2, result);
}
QTEST_MAIN(FindEmptyColumnsLeft_test)
#include "test.moc"
